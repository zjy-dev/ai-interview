    ...
    <div class="rpt-header">
      <div>
        ...
        <p class="rpt-subtitle">
          {{ store.current?.title }} · {{ store.current?.position }}
        </p>
      </div>
    </div>
    ...
    <template v-else>
      ...
      <div class="score-hero card">
        <div
          ...
          :style="
            {
              '--score-color': scoreColor(store.evaluation.overall_score),
              '--score-pct': `${store.evaluation.overall_score * 3.6}deg`,
            } as any
          "
        >
        ...
        <div class="score-info">
          <span
            class="score-badge"
            :style="{ background: scoreColor(store.evaluation.overall_score) }"
          >
...
.score-ring {
  ...
  background: conic-gradient(
    ...
    var(--surface-hover) var(--score-pct)
  );
  display: flex;
  align-items: center;
