  ...
  <div class="auth-page">
    ...
    <div class="auth-container">
      <div class="auth-brand">
        ...
        <h1>AI Interview</h1>
        <p class="tagline">开始你的 AI 面试之旅</p>
      </div>
        ...
        <form @submit.prevent="handleRegister">
          <div class="form-group">
            ...
            <div class="input-wrapper">
              ...
              <input v-model="nickname" type="text" class="form-control has-icon" placeholder="你的昵称" required />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="input-wrapper">
              ...
              <input v-model="password" type="password" class="form-control has-icon" placeholder="至少 8 位" required minlength="8" />
            </div>
          </div>
